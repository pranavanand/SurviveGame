...
var Login = React.createClass({displayName: "Login",
	...
	render: function () {
		return (
			React.createElement("div", {className: "login-screen-container"}, 
				React.createElement("h1", null, "WELCOME TO SURVIVE"), 
				React.createElement("h3", null, "Can you survive as an average dust mite? Or will you be another one who mites the dust?"), 
				React.createElement("div", {className: "input-container"}, 
					React.createElement("input", {type: "text", value: this.state.value, onChange: this.handleChange}), 
					React.createElement("input", {type: "submit", onClick: this.logIn})
				)
			)
		);
	}
...
var Build = React.createClass({displayName: "Build",
	getInitialState: function () {
		return {
			showLevel: this.props.showLevelBuilds
		}
	},
	// updateFungus: function () {
	// 	console.log("hello");
	// 	this.props.uppingFungus();
	// },
	render: function () {
		
		if (this.state.showLevelBuild == 1 || this.props.showLevel == 1) {
			
			buildsToShow = 
				React.createElement("ul", null, 
					React.createElement("li", null, builds[0].name, " ", React.createElement("button", {onClick: this.updateFungus}, "+"), " current number: ", this.props.numFungus), 
					React.createElement("li", null, builds[1].name, " ", React.createElement("button", null, "+"), " current number: ")
				)
		}
		if (this.state.showLevelBuild == 2 || this.props.showLevel == 2) {
			
			buildsToShow = 
				React.createElement("ul", null, 
					React.createElement("li", null, builds[0].name, " ", React.createElement("button", {onClick: this.updateFungus}, "+"), " current number: ", this.props.numFungus), 
					React.createElement("li", null, builds[1].name, " ", React.createElement("button", null, "+"), " current number: "), 
					React.createElement("li", null, builds[2].name, " ", React.createElement("button", null, "+"), " current number: ")
				)
		}
		if (this.state.showLevelBuild == 3 || this.props.showLevel == 3) {
			
			buildsToShow = 
				React.createElement("ul", null, 
					React.createElement("li", null, builds[0].name, " ", React.createElement("button", {onClick: this.updateFungus}, "+"), " current number: ", this.props.numFungus), 
					React.createElement("li", null, builds[1].name, " ", React.createElement("button", null, "+"), " current number: "), 
					React.createElement("li", null, builds[2].name, " ", React.createElement("button", {onClick: this.upWoker}, "+"), " current number: "), 
					React.createElement("li", null, builds[3].name, " ", React.createElement("button", null, "+"), " current number: "), 
					React.createElement("li", null, builds[4].name, " ", React.createElement("button", {onClick: this.upLibrary}, "+"), " current number: "), 
					React.createElement("li", null, builds[5].name, " ", React.createElement("button", null, "+"), " current number: ")
				)
		}
		return 
	}
...
var Events = React.createClass({displayName: "Events",
	...
	render: function () {
		return React.createElement("div", {className: "events-container"}, React.createElement("h2", null, "Events:"))
	}
});
...
/*PRIVATE*/
var OtherClans = React.createClass({displayName: "OtherClans",
	getInitialState: function () {
		return {
	...
	render: function () {
		return React.createElement("div", {className: "otherclans-container"}, React.createElement("h2", null, "Other Clans:"))
	}
});
...
var Resources = React.createClass({displayName: "Resources",
	...
	getInitialState: function () {
		return {
			...
			production: 0,
			population: 0,
			showLevelResources: 1,
			numberLibraries: 0,
			showLevelEvents: 1,
			showLevelBuild: 1,
			showLevelStats: 1,
			showLevelOtherClans: 0
		}
	},
	updateResources: function () {
		var netFood = this.state.food + (this.state.fungus*0.5 - this.state.population - this.state.workers*1.5);
		if (netFood < -10) alert("GAME OVER! Your chances of survival have been blown to dust.");
		
		if (netFood < 0) {
			if (this.state.happiness !== 'stressed') this.setState({happiness: 'stressed'});
		}
		if ((netFood > 0)&&(this.state.happiness !== 'happy')) this.setState({happiness: 'happy'});
	 	
	 	this.setState({food: netFood})

	 	var newResearch = this.state.research + 0.5*this.state.library;
	 	this.setState({research: newResearch});
	 	if (newResearch == 1.5) {
	 		alert("EVENT: An envoy from a distant clan or species appears before you. They may be traded with, made allies or enemies, or even completely ignored: the choice is up to you.");
	 		this.setState({showLevelOtherClans: 1});
	...
	upFungus: function () {
		var newFungus = this.state.fungus;
		newFungus++;
		var newFood = this.state.food;
		newFood -= 10;
		this.setState({food: newFood});
		this.setState({fungus: newFungus}); 	
	},
	upDustMite: function () {
		var newPopulation = this.state.population+1;
		this.setState({population: newPopulation});
		this.setState({showLevelBuild: 2});
	},
	upWorkers: function () {
		alert("EVENT: The humans of the house you inhabit forgot about spring cleaning. +50 food!");
		var newFood = this.state.food;
		newFood+=50;
		this.setState({food: newFood}); 
		var newPopulation = this.state.population-1;
		this.setState({population: newPopulation});
		var newWorkers = this.state.workers+1;
	...
	showBuildings: function () {
		this.setState({showLevelBuild: 3});
	},
	upLibrary: function () {
		var newLib = this.state.library+1;
		this.setState({library: newLib});
		this.setState({showLevel: 2});
	},
	...
	render: function () {
		console.log(this.state.showLevelBuild);

		if (this.state.showLevel >= 1) {
			resourcesToShow = 
				React.createElement("ul", null, 
					React.createElement("li", null, resources[0], " ", this.state.food), 
					React.createElement("li", null, resources[1], " ", this.state.population)
				)
		}
		if (this.state.showLevel >=2) {
			resourcesToShow = 
				React.createElement("ul", null, 
					React.createElement("li", null, resources[0], " ", this.state.food), 
					React.createElement("li", null, resources[1], " ", this.state.population), 
					React.createElement("li", null, resources[2], " ", this.state.research)
				)
			Researchstuff = 
			React.createElement("div", null, 
				React.createElement("h2", null, "Research:"), 
				React.createElement("ul", null, 
					React.createElement("li", null, "Education", React.createElement("button", null, "develop")), 
					React.createElement("li", null, "Agriculture", React.createElement("button", null, "develop")), 
					React.createElement("li", null, "Masonry", React.createElement("button", null, "develop"))
				)
			)
		...
		if (this.state.showLevelBuild == 1 || this.props.showLevel == 1) {
			...
			buildsToShow = 
				React.createElement("div", null, 
					...
					React.createElement("ul", null, 
						React.createElement("li", null, builds[0].name, " ", React.createElement("button", {onClick: this.upFungus}, "+"), " current number: ", this.state.fungus), 
						React.createElement("li", null, builds[1].name, " ", React.createElement("button", {onClick: this.upDustMite}, "+"), " current number: ", this.state.population)
					)
				)
		}
		if (this.state.showLevelBuild == 2 || this.props.showLevel == 2) {
			...
			buildsToShow = 
				React.createElement("div", null, 
					...
					React.createElement("h2", null, "Train your populace:"), 
					React.createElement("ul", null, 
						React.createElement("li", null, builds[2].name, " ", React.createElement("button", {onClick: this.upWorkers}, "+"), " current number: ", this.state.workers), 
						React.createElement("li", null, builds[3].name, " ", React.createElement("button", null, "+"), " current number: 0")
					)
				)
		}
		if (this.state.showLevelBuild == 3 || this.props.showLevel == 3) {
			...
			buildsToShow = 
				React.createElement("div", null, 				
					...
					React.createElement("h2", null, "Buildings:"), 
					React.createElement("ul", null, 
						React.createElement("li", null, builds[4].name, " ", React.createElement("button", {onClick: this.upLibrary}, "+"), " current number: ", this.state.library), 
						React.createElement("li", null, builds[5].name, " ", React.createElement("button", null, "+"), " current number: 0"), 
						React.createElement("li", null, builds[6].name, " ", React.createElement("button", null, "+"), " current number: 0")
					)
				)
		}
		if (this.state.showLevelOtherClans) otherclanshow = React.createElement("div", null, React.createElement("ul", null, React.createElement("li", null, React.createElement("h2", null, "Ant Clan"), React.createElement("button", null, "trade"), React.createElement("button", null, "war"))))
		return (
			React.createElement("div", null, 
				React.createElement(Stats, {startingPosition: startingPosition, happiness: this.state.happiness, showLevel: this.state.showLevelStats}), 
				React.createElement("h1", null, this.props.civName), 
				React.createElement("div", {className: "resources-container"}, 
					React.createElement("h2", null, "Resources:"), 
					React.createElement("button", {onClick: this.collectFood}, "Collect food"), 
					resourcesToShow
				), 
				...
				React.createElement(OtherClans, {showLevel: this.state.showLevelOtherClans}), 
				otherclanshow
			)
		);
	},
...
},{"./Build.jsx":2,"./Events.jsx":3,"./OtherClans.jsx":4,"./Stats.jsx":6,"react":164}],6:[function(require,module,exports){
'use strict';
var React = require('react');
/*PRIVATE*/
var statsBar = [
	...
	render: function () {
		return (
			React.createElement("div", {className: "stats-container"}, 
				...
				React.createElement("ul", null, 
					React.createElement("li", null, "Your clan started in: ", this.props.startingPosition), 
					React.createElement("li", null, statsBar[0], this.state.happiness)
				)
			)
...
var App = React.createClass({displayName: "App",
	...
	render: function () {
		var renderedVar = this.state.mainPage ? React.createElement(Resources, {civName: this.state.civName}):React.createElement(Login, {value: this.state.value, setCivName: this.setCivName, logIn: this.handleClick})
		return React.createElement("div", null, renderedVar)
	}
});

module.exports = App;

},{"./Login.jsx":1,"./Sections/Resources.jsx":5,"react":164}],8:[function(require,module,exports){
var App = require('./components/app.jsx');
var React = require('react');

React.render(React.createElement(App, null), document.getElementById('main'));

},{"./components/app.jsx":7,"react":164}],9:[function(require,module,exports){
